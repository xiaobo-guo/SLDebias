...
def parse_story_file(content):
    ...
    content = " ".join(filter(None, [x.strip()
...
def output_pairing(args):
    ...
    for filename in os.listdir(args.aligned_data):
        ...
        paired_path = os.path.join(
            args.model_outputs, "paired", paired_filename)
...
if __name__ == "__main__":
    ...
    PARSER.add_argument("--data_annotations", type=str,
                        help="Path to file human annotations")
    PARSER.add_argument("--model_outputs", type=str,
                        help="Path to directory holding model data")
    PARSER.add_argument("--story_files", type=str,
                        help="Path to directory holding CNNDM story files")
