...
from program.MyConfig import ModelArguments, DataTrainingArguments, get_config
from program.MyLogger import get_logger
...
def main():
    ...
    config, tokenizer, model = prepare_model(model_args, data_args)
...
def prepare_model(model_args: ModelArguments, data_args: DataTrainingArguments):
